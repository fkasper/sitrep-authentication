...
// VersionCommand represents the command executed by "biod version".
...
func (cmd *VersionCommand) Run(args ...string) error {
	...
	// Print version info.
	fmt.Fprintf(cmd.Stdout, "bio v%s (git: %s %s, built %s)\n", version, branch, commit, buildTime)
...
var versionUsage = `
usage: version
	version displays the bio version, build branch and git commit hash
`

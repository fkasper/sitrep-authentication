...
// Command represents the command executed by "bio run".
type Command struct {
	Version   string
	Branch    string
	Commit    string
...
func (cmd *Command) Run(args ...string) error {
	...
	log.Printf("bio starting, version %s, branch %s, commit %s, built %s",
	...
	if err := config.Validate(); err != nil {
		return fmt.Errorf("%s. To generate a valid configuration file run `bio config > bio.generated.conf`", err)
	}
